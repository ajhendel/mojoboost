...
#' @seealso [mojotrees()] for the one-call form, [predict.mb.Booster()],
...
#' Train a mojotrees model in one call
#'
...
#' @export
mojotrees <- function(data, label, params = list(), nrounds = 100L,

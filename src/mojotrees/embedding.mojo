...
CatBoost `master`, read 2026-08-16. `docs/design/CATBOOST_CATALOG.md` A20 has
...
Each is a decision, not an oversight, and each is in A20 with its reason.
...
def jacobi_eigen(
    ...
    such promise, and A20 records that an eigenvector's sign being arbitrary

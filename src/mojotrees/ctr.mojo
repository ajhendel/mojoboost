...
in `ctr_combinations.mojo` (catalog A22), which holds the binarized half of
...
# The projection itself lives in `ctr_combinations.mojo` (catalog A22); this
...
def check_ctr_complexity(max_ctr_complexity: Int) raises:
    ...
    landed (catalog A22) and `ctr_combinations.mojo` now holds the binarized

...
Catalog A17. Off by default, reached by nothing, and it changes no existing
...
def permutation_is_needed(
    ...
    coupling between catalog A16 and A17 and it runs in the direction people do
...
def check_ctr_trainer_support(params: CtrParams) raises:
    ...
    if params.enabled:
        raise Error(
            ...
            " appends ctr columns to the design matrix yet (catalog A17)"
        )

...
src/mojotrees/target_matrix.mojo; docs/design/CATBOOST_CATALOG.md A17-A19).
...
def test_survival_aft_applies_sample_weight() raises:
    ...
    # divergence recorded in catalog A18.
...
def test_survival_aft_predicted_time_is_the_exp_link() raises:
    ...
    # after CROSS_ENTROPY = 12.
    assert_equal(COX, 13)
    assert_equal(SURVIVAL_AFT, 14)
...
def test_train_multi_rmse_is_t_independent_squared_error_fits() raises:
    ...
    # the A19 caveat has to be rewritten.
    var data = _binned()

...
| GPU tuning | `MOJOTREES_GPU_BATCH_SLOTS`, `MOJOTREES_GPU_CLASS_BATCH`, `MOJOTREES_GPU_CLASS_BATCH_BYTES`, `MOJOTREES_GPU_GRAD_LAYOUT`, `MOJOTREES_GPU_HIST_SPECIALIZATION`, `MOJOTREES_GPU_OBJECTIVE`, `MOJOTREES_GPU_MIN_TILES`, `MOJOTREES_GPU_SCAN_PRIMITIVES`, `MOJOTREES_GPU_SPARSE_SKIP_FREQ`, `MOJOTREES_GPU_SPLIT_PRIMITIVES`, `MOJOTREES_GPU_SPLIT_STRATEGY`, `MOJOTREES_GPU_STAGING_SLOTS`, `MOJOTREES_GPU_TRANSFER`, `MOJOTREES_GPU_VALID_SCORING`, `MOJOTREES_GPU_WARMUP` |
| Diagnostics and tracing | `MOJOTREES_GPU_TRACE`, `MOJOTREES_GPU_VERIFY_ROWS`, `MOJOTREES_STARTUP_TRACE`, `MOJOTREES_STARTUP_REPORT_FD` |
